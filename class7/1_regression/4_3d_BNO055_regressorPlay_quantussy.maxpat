        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 646.0, 420.0, 169.0, 67.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 10,
                    "outlettype": [ "", "", "", "", "", "", "", "", "", "" ],
                    "patching_rect": [ 625.0, 172.5, 295.3, 153.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 594.0, 337.5, 326.0, 23.0 ],
                    "text": "live.adsr~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "float" ],
                    "patching_rect": [ 457.0, 243.0, 39.0, 22.0 ],
                    "text": "/ 127."
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 457.0, 146.5, 61.0, 22.0 ],
                    "text": "r midiport"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 513.0, 206.5, 54.0, 33.0 ],
                    "text": "gesture active"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 457.0, 212.0, 52.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "int", "int" ],
                    "patching_rect": [ 457.0, 182.5, 49.0, 22.0 ],
                    "text": "ctlin 80"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 383.0, 145.5, 61.0, 22.0 ],
                    "text": "s midiport"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 594.0, 301.5, 24.0, 24.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 492.0, 390.5, 123.0, 37.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 403.0, 452.0, 89.0, 22.0 ],
                    "text": "read qnt-2.json"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 403.0, 424.0, 89.0, 22.0 ],
                    "text": "read qnt-1.json"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 403.0, 390.5, 33.0, 22.0 ],
                    "text": "read"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 323.5, 717.0, 29.5, 22.0 ],
                    "text": "*~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 207.0, 717.0, 29.5, 22.0 ],
                    "text": "*~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 323.5, 662.0, 54.0, 22.0 ],
                    "text": "*~ 0.444"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 207.0, 662.0, 54.0, 22.0 ],
                    "text": "*~ 0.444"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 447.0, 391.5, 20.0, 20.0 ],
                    "rounded": 60.0,
                    "saved_attribute_attributes": {
                        "bgcolor": {
                            "expression": "themecolor.lesson_step_circle"
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 333.0, 754.0, 333.5, 754.0 ],
                    "source": [ "obj-101", 0 ]
                }
            },
            {
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 594.96875, 585.8046875 ],
                    "order": 0,
                    "source": [ "obj-37", 0 ]
                }
            },
