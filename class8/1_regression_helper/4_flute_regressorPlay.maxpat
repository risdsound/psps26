        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 678.0, 363.0, 33.0, 22.0 ],
                    "text": "read"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 396.1164994239807, 287.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "fontsize": 13.0,
                    "id": "obj-36",
                    "items": [ "IAC Driver Bus 1", ",", "to Max 1", ",", "to Max 2", ",", "BNO055_BMP280_MIDI Bluetooth" ],
                    "maxclass": "umenu",
                    "numinlets": 1,
                    "numoutlets": 3,
                    "outlettype": [ "int", "", "" ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 482.0, 606.0, 150.0, 20.0 ]
                                }
                            },
                            {
                                "box": {
