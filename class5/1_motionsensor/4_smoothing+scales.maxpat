        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 33.0, 464.0, 61.0, 22.0 ],
                    "text": "pak 0. 10."
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 33.0, 503.0, 34.0, 22.0 ],
                    "text": "line~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 33.0, 432.0, 32.0, 22.0 ],
                    "text": "mtof"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 33.0, 545.0, 37.0, 22.0 ],
                    "text": "saw~"
                }
            },
            {
                "box": {
                    ...
                    "parameter_enable": 1,
                    "patching_rect": [ 33.0, 579.0, 136.0, 47.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 2,
                    "numoutlets": 0,
                    "patching_rect": [ 33.0, 646.0, 35.0, 22.0 ],
                    "text": "dac~"
                }
            },
            {
