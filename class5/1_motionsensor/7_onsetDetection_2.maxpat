        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 309.0, 291.0, 150.0, 60.0 ],
                    "text": "here a side to side tilt triggers the note\nrequires more effort\nto make note"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "int", "int" ],
                    "patching_rect": [ 255.0, 313.0, 48.0, 22.0 ],
                    "text": "change"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 255.0, 281.0, 36.0, 22.0 ],
                    "text": "> 0.5"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 255.0, 393.0, 24.0, 24.0 ]
                }
            },
            {
                "box": {
