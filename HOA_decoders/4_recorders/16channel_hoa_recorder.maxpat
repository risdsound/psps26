...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 583.0, 397.0, 111.0, 169.0 ],
					"presentation" : 1,
					"presentation_linecount" : 8,
					"presentation_rect" : [ 363.0, 207.0, 166.0, 106.0 ],
					"style" : "helpfile_label",
					"text" : "This recording patch is for capturing a HOA encoded signal (third order, 16 channels).  You must have a mc.send~ object in your encoder patch that matches the mc.receive~ in this patch."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 73.0, 314.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 186.0, 19.0, 168.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-15" : [ "mc.live.gain~", "HOA ENCODED", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
,
		"dependency_cache" : [  ],
		"autosave" : 0,
		"bgcolor" : [ 0.384313725490196, 1.0, 0.988235294117647, 0.901960784313726 ]
	}
