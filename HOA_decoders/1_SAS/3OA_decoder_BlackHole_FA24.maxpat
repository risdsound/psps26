...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1012.0, 87.0, 35.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1078.0, 105.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 912.0, 37.0, 320.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1078.0, 82.0, 320.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1012.0, 115.0, 83.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1078.0, 133.0, 83.0, 22.0 ],
					"text" : "mc.sfplay~ 16"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.038406372070312, 637.330800235271454, 231.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 38.0, 150.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 384.0, 6.0, 262.0, 20.0 ],
					"text" : "DECODER UPDATE - AUGUST 28 2024"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1356.0, -18.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1356.0, -18.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 357.0, 71.0, 81.0, 22.0 ],
					"text" : "loadmess -70"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 594.337516367435455, 60.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 594.337516367435455, 60.0, 150.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 426.0, 170.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.0, 170.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 363.0, 218.0, 95.0, 22.0 ],
					"text" : "mc.sfrecord~ 16"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 768.076388776302338, 125.830792009830475, 243.0, 20.0 ],
					"text" : "mc.receive~ must have matching mc.send~ "
				}
...
, 			{
				"box" : 				{
					...
					"text" : "inputs 1 - 16, use BlackHole device for input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 57.038406372070312, 60.0, 260.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 57.038406372070312, 60.0, 260.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 57.038406372070312, 481.5, 410.0, 76.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 57.038406372070312, 570.5, 408.0, 62.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
